...
namespace ZAP.Ecosystem.HRM.Infrastructure.Data.Repositories;
    public class OrganizationRepository : ZAP.Ecosystem.Shared.Data.BaseRepository<OrganizationUnit>, IOrganizationRepository
    {
        private readonly EcosystemDbContext _context;
        public OrganizationRepository(EcosystemDbContext context) : base(context)
        {
            _context = context;
        }
