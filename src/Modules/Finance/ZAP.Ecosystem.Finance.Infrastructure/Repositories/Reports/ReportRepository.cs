...
namespace ZAP.Ecosystem.Finance.Infrastructure.Data.Repositories.Reports;
    public class ReportRepository : ZAP.Ecosystem.Shared.Data.BaseRepository<ReportTemplate>, IReportRepository
    {
        private readonly EcosystemDbContext _context;
        public ReportRepository(EcosystemDbContext context) : base(context)
        {
            _context = context;
        }
    }
