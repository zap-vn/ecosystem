...
namespace ZAP.Ecosystem.Finance.Infrastructure.Data.Repositories;
    public class PaymentTermsRepository : ZAP.Ecosystem.Shared.Data.BaseRepository<PaymentTerms>, IPaymentTermsRepository
    {
        private readonly EcosystemDbContext _context;
        public PaymentTermsRepository(EcosystemDbContext context) : base(context)
        {
            _context = context;
        }
    }
