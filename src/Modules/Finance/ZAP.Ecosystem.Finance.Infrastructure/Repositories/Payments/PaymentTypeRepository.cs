...
namespace ZAP.Ecosystem.Finance.Infrastructure.Data.Repositories;
    public class PaymentTypeRepository : ZAP.Ecosystem.Shared.Data.BaseRepository<PaymentType>, IPaymentTypeRepository
    {
        private readonly EcosystemDbContext _context;
        public PaymentTypeRepository(EcosystemDbContext context) : base(context)
        {
            _context = context;
        }
    }
