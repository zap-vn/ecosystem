...
namespace ZAP.Ecosystem.Finance.Infrastructure.Data.Repositories;
    public class PaymentMethodRepository : ZAP.Ecosystem.Shared.Data.BaseRepository<PaymentMethod>, IPaymentMethodRepository
    {
        private readonly EcosystemDbContext _context;
        public PaymentMethodRepository(EcosystemDbContext context) : base(context)
        {
            _context = context;
        }
    }
