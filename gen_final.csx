...
";
    ...
    // Generic REST endpoints without wildcards for base routes
    yaml += $@"
  /api/{r}:
    get:
      operationId: get_{id}
...
File.WriteAllText(@"d:\PROJECTS\4_CRM_API\openapi.yaml", yaml);
